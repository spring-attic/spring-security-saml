...
import sample.SimpleServiceProviderApplication.JavaOnlyConditionExample;
...
@EnableWebSecurity
@Conditional(JavaOnlyConditionExample.class)
public class JavaOnlySecurityConfiguration {
	...
	public static class SamlSecurity extends WebSecurityConfigurerAdapter {
		...
		public SamlSecurity(SamlTransformer samlTransformer) {
