...
public class SamlServiceProviderBeanConfiguration {
	...
	public ServiceProviderMetadataResolver serviceProviderMetadataResolver(SamlTransformer transformer) {
		return new ServiceProviderMetadataResolver(transformer);
	}
