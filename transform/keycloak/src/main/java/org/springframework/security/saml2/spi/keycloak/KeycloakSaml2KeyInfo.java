...
class KeycloakSaml2KeyInfo {
	private final KeyPair keyPair;
	private X509Certificate certificate;

	KeycloakSaml2KeyInfo(Saml2KeyStoreProvider provider, Saml2KeyData key) throws UnrecoverableKeyException, NoSuchAlgorithmException,
																				  KeyStoreException {
