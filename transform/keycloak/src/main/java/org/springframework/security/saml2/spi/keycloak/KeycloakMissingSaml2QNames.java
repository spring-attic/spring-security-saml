...
public enum KeycloakMissingSaml2QNames implements HasQName {

	ATTR_SESSION_NOT_ON_OR_AFTER(null, "SessionNotOnOrAfter");

	private final QName qName;

	private KeycloakMissingSaml2QNames(String localName) {
		this(JBossSAMLURIConstants.ASSERTION_NSURI, localName);
	}

	private KeycloakMissingSaml2QNames(HasQName source) {
		this.qName = source.getQName();
	}

	private KeycloakMissingSaml2QNames(JBossSAMLURIConstants nsUri, String localName) {
