...
public class KeycloakSaml2Parser extends AbstractParser {
	...
	static {
		...
		PARSERS.put(SAMLProtocolQNames.ASSERTION.getQName(), () -> new KeycloakSaml2AssertionParser());
		PARSERS.put(SAMLProtocolQNames.NAMEID.getQName(), () -> new KeycloakSaml2NameIdParser());
		PARSERS.put(
			SAMLProtocolQNames.ENCRYPTED_ASSERTION.getQName(),
			() -> SAMLEncryptedAssertionParser.getInstance()
		);

		PARSERS.put(SAMLAssertionQNames.AUTHN_STATEMENT.getQName(), () -> new KeycloakSaml2AuthnStatementParser());
