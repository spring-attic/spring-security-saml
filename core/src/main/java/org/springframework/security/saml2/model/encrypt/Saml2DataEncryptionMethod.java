...
public enum Saml2DataEncryptionMethod {
	...
	Saml2DataEncryptionMethod(String urn) {
	...
	public static Saml2DataEncryptionMethod fromUrn(String other) {
		for (Saml2DataEncryptionMethod name : values()) {
