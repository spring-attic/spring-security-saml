...
public enum Saml2AuthenticationContextClassReference {
	/**
	 * Internet Protocol
	 */
	...
	Saml2AuthenticationContextClassReference(String urn) {
		this.urn = urn;
	}

	public static Saml2AuthenticationContextClassReference fromUrn(String ctxRef) {
		for (Saml2AuthenticationContextClassReference ref : values()) {
