...
public class KeycloakSaml2AuthnStatementParser extends AbstractStaxSamlAssertionParser<AuthnStatementType> {

	KeycloakSaml2AuthnStatementParser() {
	...
	protected AuthnStatementType instantiateElement(XMLEventReader xmlEventReader, StartElement element) throws
		...
		res.setSessionNotOnOrAfter(StaxParserUtil.getXmlTimeAttributeValue(element, KeycloakMissingSaml2QNames.ATTR_SESSION_NOT_ON_OR_AFTER));
		return res;
	}
