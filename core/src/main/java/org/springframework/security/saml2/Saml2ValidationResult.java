...
public class Saml2ValidationResult {
	...
	public Saml2ValidationResult addError(String error) {
	...
	public Saml2ValidationResult addError(ValidationError error) {
	...
	public Saml2ValidationResult setErrors(List<ValidationError> errors) {
		this.errors.clear();
