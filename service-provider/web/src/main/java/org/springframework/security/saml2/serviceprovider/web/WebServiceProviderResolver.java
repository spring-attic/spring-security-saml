...
public class WebServiceProviderResolver implements Saml2ServiceProviderResolver<HttpServletRequest> {
	...
	public WebServiceProviderResolver(Saml2ServiceProviderMetadataResolver metadataResolver,
