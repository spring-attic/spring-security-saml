...
public class Saml2Endpoint {
	...
	public Saml2Endpoint setIndex(int index) {
		this.index = index;
		return this;
	}
	...
	public Saml2Endpoint setDefault(boolean isDefault) {
	...
	public Saml2Endpoint setBinding(Saml2Binding binding) {
	...
	public Saml2Endpoint setLocation(String location) {
	...
	public Saml2Endpoint setResponseLocation(String responseLocation) {
