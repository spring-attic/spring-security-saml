...
import static org.springframework.security.saml.model.signature.AlgorithmMethod.RSA_SHA512;
...
import static org.springframework.security.saml.model.signature.DigestMethod.SHA512;
...
class LogoutObjectTests {
	...
	public void requestFromXml() {
		LogoutRequest request = (LogoutRequest) saml.fromXml(
