...
public enum CanonicalizationMethod {
	...
	ALGO_ID_C14N_OMIT_COMMENTS("https://www.w3.org/TR/2001/REC-xml-c14n-20010315"),
	ALGO_ID_C14N_WITH_COMMENTS(ALGO_ID_C14N_OMIT_COMMENTS.toString() + "#WithComments"),
	ALGO_ID_C14N11_OMIT_COMMENTS("https://www.w3.org/2006/12/xml-c14n11"),
	ALGO_ID_C14N11_WITH_COMMENTS(ALGO_ID_C14N11_OMIT_COMMENTS.toString() + "#WithComments"),
	ALGO_ID_C14N_EXCL_OMIT_COMMENTS("https://www.w3.org/2001/10/xml-exc-c14n#"),
