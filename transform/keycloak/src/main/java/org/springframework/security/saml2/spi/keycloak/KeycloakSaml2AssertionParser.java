...
public class KeycloakSaml2AssertionParser extends AbstractStaxSamlAssertionParser<AssertionType> {

	private static final String VERSION_2_0 = "2.0";

	KeycloakSaml2AssertionParser() {
	...
	protected void processSubElement(XMLEventReader xmlEventReader,
		...
		switch (element) {
			...
			case AUTHN_STATEMENT:
				target.addStatement(new KeycloakSaml2AuthnStatementParser().parse(xmlEventReader));
				break;
