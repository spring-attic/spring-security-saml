 ...
 * </ul>
 */
public class Saml2Metadata<T extends Saml2EntityDescriptor<T>> extends Saml2EntityDescriptor<T> implements Saml2Object {
	/*
	...
	public Saml2Metadata(Saml2Metadata<T> other) {
		super(other);
	...
	public Saml2Metadata<T> setNext(T next) {
		this.next = next;
		return this;
	}
