...
public enum Saml2NameIdFormat {
	...
	Saml2NameIdFormat(String urn) {
		Assert.notNull(urn, "URN must not be null");
		this.urn = urn;
	}

	public static Saml2NameIdFormat fromUrn(URI other) {
		Assert.notNull(other," NameIdFormat URN must not be null");
		return fromUrn(other.toString());
	}

	public static Saml2NameIdFormat fromUrn(String other) {
		Assert.notNull(other," NameIdFormat URN must not be null");
		for (Saml2NameIdFormat name : values()) {
