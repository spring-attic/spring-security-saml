...
/* ********  P U B L I C   F I E L D S  ******** */
	 ...
	 */
      ...
      * @see ://github.com/ESAPI/esapi-java-legacy/issues/354
      * @see ://foxglovesecurity.com/2015/11/06/what-do-weblogic-websphere-jboss-jenkins-opennms-and-your-application-have-in-common-this-vulnerability/
      */
...
/* ********  P R I V A T E   F I E L D S  ******** */
    ...
    private static final org.apache.commons.logging.Log logger = LogFactory.getLog(Base64.class);
...
/* ********  D E T E R M I N E   W H I C H   A L H A B E T  ******** */
     ...
     */
    public final static void usage( String msg )
    {
...
/* ********  E N C O D I N G   M E T H O D S  ******** */
    ...
    public static String encodeObject( java.io.Serializable serializableObject, int options )
    {
        ...
        {
            logger.error("Problem writing object", e );
            return null;
        }   // end catch
        finally
        {
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    public static byte[] decode( String s, int options )
    {
        ...
        catch( java.io.UnsupportedEncodingException uee )
        {
            ...
            logger.warn("Problem decoding string using " +
    ...
    public static Object decodeToObject( String encodedObject )
    {
        ...
        {
            logger.error("Problem reading object", e );
            obj = null;
        }   // end catch
