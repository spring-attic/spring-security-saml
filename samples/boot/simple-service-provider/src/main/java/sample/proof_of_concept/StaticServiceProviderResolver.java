...
public class StaticServiceProviderResolver {
	...
	private static Log logger = LogFactory.getLog(StaticServiceProviderResolver.class);
	...
	public StaticServiceProviderResolver(SamlTransformer samlTransformer,
	...
	public HostedServiceProvider resolve(HttpServletRequest request) {
		ServiceProviderMetadata metadata = generateMetadata(request);
		Map<ExternalIdentityProviderConfiguration, IdentityProviderMetadata> providers = getProviders();
